<!-- 9db145a8-ca6b-4012-aeee-3eabede923b7 b4e4b4bf-a936-45a1-976d-0a8ccbe046eb -->
...
- [ ] Create monorepo structure with desktop, mcp-server, shared packages
- [ ] Define SQLite schema and migrations; enable WAL mode
- [ ] Implement import pipeline (copy, hash, sharp, palette, layout)
- [ ] Build React UI: Library, Importer, Detail editor, Settings
- [ ] Add Tauri commands for file ops, DB, and MCP lifecycle
- [ ] Implement TypeScript MCP server with tools and JSON types
- [ ] Publish shared Zod types and design-specs JSON schema
- [ ] Package MCP server as standalone binary and integrate with app
- [ ] Add unit/integration/E2E tests and fixtures; basic CI
- [ ] Write README with run/build instructions and MCP tool docs